...
app.post("/webhook", async (req, res) => {
  ...
  try {
    ...
    if (debeActivarMenu || inputId === "menu_principal") {
      ...
      if (inputId === "op_1")
        txt = "Aquí te dejo el catálogo detallado, con los tipos de sesiones que hago y precios 📸: https://wa.me/c/50687086658";

      else if (inputId === "op_2")
      ...
      else if (inputId === "op_3")
        txt = "Estoy ubicado en San Jose, Escazú, San Antonio 📍. Y de Lunes a Viernes de 9:00 am a 7:00 pm, Sabados y Domingos de 9:00 am a 3:00 pm.";

      else if (inputId === "op_4")
        txt = "Te comparto un poco de los clintes que han confiando en mi trabajo: https://bshutterstories.pixieset.com/bshutterportfolio/";
